...
class RAG:
    def __init__(self):
        ...
        หน้าที่ของคุณคือช่วยผู้เล่นตอบคำถามเรื่องภาษีของประเทศไทย โดยอ้างอิงจากข้อมูลที่ได้รับเท่านั้นข้อมูลอ้างอิง (Context):{context}
        ...
        ข้อกำหนดการตอบ:
            ...
            3. ถ้าข้อมูลใน Context ไม่พอ ให้ตอบว่า "เรื่องนี้ฉันยังไม่มีข้อมูลในคัมภีร์ ลองถามเรื่องอื่นดูนะ" (ห้ามมั่วเองเด็ดขาด)
